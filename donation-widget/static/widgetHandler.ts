...
const merchantKeyPair: string = widgetParams.split("&")[0];
const merchantIdPair: string = widgetParams.split("&")[1];
...
const phone: HTMLInputElement = document.querySelector("#phoneInput")!;
const email: HTMLInputElement = document.querySelector("#email")!

// Widget page 2 variables
const toggleDedicatedInputWrapper: HTMLInputElement = document.querySelector("#ToggleDedicatedInputWrapper")!;
const dedicatedInput: HTMLInputElement = document.querySelector("#DedicatedInput")!;
const toggleCompanyInputWrapper: HTMLInputElement = document.querySelector("#ToggleCompanyInputWrapper")!;
const companyInput: HTMLInputElement = document.querySelector("#CompanyInput")!;

// Widget error arrays
var pageOneErrors: Array<boolean> = [true, true, true, true];
var pageTwoErrors: Array<boolean> = [false, false];
var pageThreeErrors: Array<boolean> = [true]

// Widget page 3 variables
const customAmount: HTMLInputElement = document.querySelector("#customAmount")!;
const amountField: HTMLInputElement = document.querySelector("#donationAmount")!;
const customAmountWrapper: HTMLElement = document.querySelector("#customAmountWrapper")!;

// Capturing the rest of form values
const country: HTMLInputElement = document.querySelector("#countryPicker")
console.log(`Country: ${country.value}`)
const anonymousDonation: HTMLInputElement = document.querySelector("#anonymousDonation")
console.log(`Anonymous donation: ${anonymousDonation.checked}`)

function navigateToFormStep (stepNumber: number): void {
...
function handleVisibility(trigger:HTMLInputElement) {
...
function checkPage(errors: Array<boolean>, page:string){
  let btn: HTMLElement = document.querySelector("#"+page+"Btn")!
  errors.every((error: boolean)=>{
    if(error){
