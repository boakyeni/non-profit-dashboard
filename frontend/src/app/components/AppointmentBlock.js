...
const AppointmentBlock = ({ icon }) => {
    ...
    return (
        <>
            <Link href="/dashboard/profile" className="relative overflow-visible flex flex-row bg-white border-slate-300 border drop-shadow-md justify-between h-[166px] m-4 p-6 rounded-2xl" onClick={handleClick} >
