...
import { toggleCreateCalendarModal } from "../../../lib/features/events/eventSlice"
...
const CreateCalendarModal = () => {
    ...
    const { createCalendarModalOpen } = useSelector((state) => state.events)
                ...
                <div className="relative w-full max-w-2xl  ">
                    ...
                    <form className="relative bg-white rounded-2xl shadow ">
                        ...
                        <div className="flex items-center p-6 space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b ">
                            <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center " >Add Calendar</button>
